...
let User = exports.User = class User extends core_1.BaseEntity {
    constructor() {
        super(...arguments);
        this.id = (0, uuid_1.v4)();
...
__decorate([
    (0, core_1.OneToMany)('FridgeProduct', 'user'),
    __metadata("design:type", Object)
], User.prototype, "fridgeProducts", void 0);
__decorate([
    (0, core_1.OneToMany)('Recipe', 'user'),
    __metadata("design:type", Object)
